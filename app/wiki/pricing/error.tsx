...
export default function PricingWikiError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('Pricing wiki error:', error)
  }, [error])
    ...
    <div className="min-h-screen bg-[#f9f6f7] flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-base sm:text-[17px] text-[#1f2933] mb-8 leading-[1.65]">
          {error.message || 'An unexpected error occurred while loading the pricing wiki.'}
        </p>
