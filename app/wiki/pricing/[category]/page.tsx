...
export default function CategoryPage({ params }: CategoryPageProps) {
  ...
  const extractWhatsInCategorySection = (
    content: string
  ): { content: string; workingNote: string } => {
    ...
    for (const line of lines) {
      ...
      if (
        ...
        !line.includes("What's in this category")
      ) {
      ...
      if (inWhatsInSection) {
        ...
        if (
          ...
          (trimmedLine.includes('currently working') || trimmedLine.includes('working on'))
        ) {
  ...
  const extractHowToUseSection = (content: string): string => {
    ...
    return extractSection(content, '## How startup founders can use these concepts', [
      '## Related categories',
    ])
  }
  ...
  const extractInsights = (content: string): { title: string; content: string }[] => {
    const raw = extractSection(content, '## Insights', [
      '## How to use this',
      '## Related categories',
    ])
    if (!raw.trim()) return []
  ...
  const extractHowToUseCards = (content: string): { title: string; content: string }[] => {
    ...
    const withoutHeader = raw
      .replace(/^## How to use this\s*\n?/i, '')
      .replace(/^## How startup founders can use these concepts\s*\n?/i, '')
  ...
  const extractHowToUseWorkflow = (
    content: string
  ): {
    title: string
    description: string
    steps: { number: string; title: string; subtitle: string }[]
  } | null => {
    const raw = extractHowToUseSection(content)
  ...
  const { content: whatsInCategoryContent, workingNote } = extractWhatsInCategorySection(
    category.content
  )
  const howToUseContent = extractHowToUseSection(category.content)
  const summarySectionContent = extractSection(category.content, '## Summary', [
    "## What's in this category",
  ])
  const coreConceptsContent = extractSection(category.content, '## Core Concepts', [
    '## How to use this',
    '## Related categories',
  ])
                ...
                <div className="prose prose-lg max-w-none text-text">
                  <ReactMarkdown
                    ...
                    components={{
                      p: ({ node, ...props }: any) => (
                        <p
                          className="text-base sm:text-[17px] leading-[1.65] mb-4 text-justify"
                          {...props}
                        />
                      ),
                      ...
                      a: ({ node, ...props }: any) => (
                        <a className="text-brand-ink hover:underline font-medium" {...props} />
                      ),
                    }}
                  >
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-between h-full">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Anchors prices to the measurable value you create and your customers'
                          willingness to pay, rather than your internal costs or competitors'
                          numbers. This is the long-run "gold standard" for SaaS pricing and the
                          core philosophy behind the rest of the wiki.
                        </p>
                      </Link>
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Treats pricing as an operating system for the business: a deliberate way
                          of deciding how you charge, what you charge, and when you change prices,
                          so profit, growth, and positioning stay aligned. Prevents "random walk"
                          pricing and ensures every change in price has a clear objective and owner.
                        </p>
                      </Link>
                    </div>
                      ...
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <h4 className="font-semibold text-text text-lg">
                            {insights[0]?.title || 'Strategic Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[0]?.content && (
                            <ReactMarkdown
                              ...
                              rehypePlugins={[rehypeRaw]}
                              components={{
                                p: ({ node, ...p }: any) => <p className="mb-0" {...p} />,
                                a: ({ node, ...p }: any) => (
                                  <a
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    ...
                    <div className="lg:col-span-5 flex">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[1]?.title || 'Pricing Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[1]?.content && (
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-between h-full">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Starts from unit cost and adds a margin to "keep things simple"; useful as
                          a floor and sanity check for unit economics, but too blunt and
                          inward-looking as a primary strategy.
                        </p>
                      </Link>
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Sets prices relative to competitors' price points, discounts, and bundles;
                          good as reference points, risky as a default strategy.
                        </p>
                      </Link>
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Charges each buyer as much as you can extract in the moment through
                          negotiation; can boost short-term revenue, but trains aggressive
                          bargaining and undermines fairness, trust, and long-term relationships.
                        </p>
                      </Link>
                    </div>
                  </div>
            ...
            {params.category === 'foundations' && (
              <div className="mt-16 mb-12">
                ...
                <p className="text-text text-base sm:text-[17px] leading-[1.65] mb-10 max-w-3xl">
                  Once you understand your range, you must choose a strategic posture based on your
                  market differentiation, growth goals, and constraints.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-text leading-relaxed text-base mb-4">
                        Setting a high initial price to "skim" the most profitable segments of the
                        market before lowering it or introducing lower tiers.
                      </p>
                      <div className="mt-4">
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-text leading-relaxed text-base mb-4">
                        Setting a low price to attract a large number of buyers quickly and win
                        market share, betting on lifetime value and scale.
                      </p>
                      <div className="mt-4">
                        <p className="text-xs font-semibold text-text-muted uppercase mb-2">
                          WHEN TO USE:
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-text leading-relaxed text-base mb-4">
                        Optimizing price to squeeze out maximum possible revenue/profit from the
                        existing customer base within a specific timeframe.
                      </p>
                      <div className="mt-4">
                        <p className="text-xs font-semibold text-text-muted uppercase mb-2">
                          WHEN TO USE:
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          The account/segment profile that gets the most value from your offer—and
                          delivers the best acquisition, retention, and expansion economics. Use it
                          to focus targeting and pricing power so you're not building (or
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          A concrete description of who uses you for what problem, in what context,
                          and versus which alternative. Use it to align packaging and pricing to
                          real workflows and stakes instead of feature lists.
                        </p>
                      </Link>
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          A lens that frames demand as the "progress" customers are trying to make,
                          not the persona they belong to. Use it when messaging and onboarding feel
                          fuzzy and you need a crisp "why now."
                        </p>
                      </Link>
                    </div>
                    ...
                    <div className="lg:col-span-5 flex">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[0]?.title || 'Foundation Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[0]?.content && (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    ...
                    <div className="lg:col-span-5 flex">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[1]?.title || 'Value Logic Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[1]?.content && (
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          The specific benefits that create utility (time saved, risk reduced,
                          revenue gained, convenience, status, etc.). Use it to justify pricing,
                          prioritize roadmap, and design tiers around outcomes customers actually
                          pay for.
                        </p>
                      </Link>
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          A value-based pricing method that anchors on the next-best alternative
                          (reference value) and adds/subtracts your differentiation value. Use it to
                          build a defendable ROI narrative and a credible value-based ceiling.
                        </p>
                      </Link>
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          A structured way to translate perceived value into a price band by
                          anchoring on the alternative and adjusting for differences and context.
                          Use it when budgets, complements, timing, or market environment change
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          The distribution of maximum acceptable prices across customers, not a
                          single number. Use it to validate your value-based range, choose price
                          points, and design tiers with evidence.
                        </p>
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Grouping customers by distinct jobs/use cases and WTP so one price doesn't
                          undercharge some and exclude others. Use it to decide tiering, packaging,
                          and go-to-market focus without drowning in complexity.
                        </p>
                      </Link>
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Enforceable rules that let different segments pay different effective
                          prices with minimal leakage and manageable fairness risk. Use it to
                          capture more surplus than blanket discounts—while protecting your premium
                          segment.
                        </p>
                      </Link>
                    </div>
                    ...
                    <div className="lg:col-span-5 flex">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[2]?.title || 'Capture Mechanism Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[2]?.content && (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    <div className="lg:col-span-5 flex order-2 lg:order-1">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[0]?.title || 'Blueprint Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[0]?.content && (
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-4 order-1 lg:order-2">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          The structural design of what you sell (plans, modules, upgrade paths) and
                          how customers move up—independent of exact price points. Use it to reduce
                          decision friction, increase ACV, and avoid feature giveaways that kill
                          margins.
                        </p>
                      </Link>
                    </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Classify features by impact on purchase decisions: leaders that drive tier
                          choice, fillers that make the tier feel complete, killers that devalue the
                          tier. Use it to design high-converting tiers and avoid feature soup.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          A tiered packaging pattern (typically 3 plans) that offers entry,
                          mass-market, and premium options to anchor value, segment buyers, and
                          create predictable upgrade paths.
                        </p>
                      </Link>
                    </div>
                    <div className="lg:col-span-5 flex">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[1]?.title || 'Tier design Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[1]?.content && (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    <div className="lg:col-span-5 flex">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[2]?.title || 'Expansion Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[2]?.content && (
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Customers buy a core offer, then optionally purchase add-ons (modules) to
                          tailor the product. Use it to capture WTP differences, keep entry plans
                          simple, and create repeatable expansion paths.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        <div className="flex items-center gap-3 mb-0">
                          ...
                          <h3 className="font-semibold text-text text-lg no-underline">Bundling</h3>
                          <span className="bg-green-500 text-white text-xs font-semibold px-2 py-1 rounded uppercase">
                            Expansion
                          </span>
                        </div>
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Selling multiple complementary products together at one price to increase
                          total revenue and customer stickiness. Use it when customers value
                          different items differently and marginal cost per extra item is low.
                        </p>
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          The overarching blueprint defining how your business captures value and
                          generates cash flow. Use it to align product design, GTM motion, and unit
                          economics before setting price points.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          The specific unit you charge for (per user, per API call, per gigabyte)
                          that should track customer value and your cost-to-serve. Use it to drive
                          expansion revenue naturally and avoid ghost churn.
                        </p>
                      </Link>
                    </div>
                    <div className="lg:col-span-5 flex">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    <div className="lg:col-span-5 flex">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[1]?.title || 'Revenue Engines Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[1]?.content && (
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Recurring fee for ongoing access when value is continuous and usage is
                          frequent. Use it to build predictable MRR and manage retention as the core
                          growth lever.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Flat recurring fee per user when value scales with headcount and buyers
                          want budget predictability. Watch utilization to avoid shelfware and
                          renewal pressure.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Charge by measured consumption when usage is the clearest proxy for value
                          and costs scale with use. Add allowances, alerts, and caps to avoid
                          bill-shock churn.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Charge per auditable, discrete value event (for example, payment captured
                          or booking completed). It aligns price with realized activity while
                          preserving simple buyer logic.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Tie price to verified results when outcomes are measurable and
                          attributable. Use it to share risk and capture a share of value
                          created—requires clear metrics and attribution rules.
                        </p>
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    <div className="lg:col-span-7 flex flex-col gap-4">
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Base subscription plus variable usage to balance predictability for buyers
                          and upside capture for you. Mature startups almost always graduate to
                          hybrid when pure seat-based limits growth and pure usage-based hurts
                          predictability.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          Customers pre-commit budget into a wallet and usage burns it down over
                          time. This adds procurement-friendly predictability without giving up
                          consumption-based fairness.
                        </p>
                      </Link>
                      <Link
                      ...
                      >
                        ...
                        <p className="text-text leading-tight text-sm ml-9 mt-0 text-justify">
                          A customer acquisition strategy (not a true revenue model) that offers a
                          perpetual free tier to lower entry barriers. Treat free as a marketing
                          expense; design clear fences so users upgrade for meaningful reasons.
                        </p>
                      </Link>
                    </div>
                    <div className="lg:col-span-5 flex">
                      <div className="bg-surface rounded-lg p-6 shadow-sm sticky top-24 w-full">
                        <div className="flex items-center gap-2 mb-1">
                          <Lightbulb className="w-5 h-5 text-yellow-500 fill-yellow-500" />
                          <h4 className="font-semibold text-text text-lg">
                            {insights[2]?.title || 'Advanced & GTM Insight'}
                          </h4>
                        </div>
                        <div className="text-base sm:text-[17px] text-text leading-[1.65] text-justify prose prose-sm max-w-none">
                          {insights[2]?.content && (
                  ...
                  <div className="prose prose-lg max-w-none text-text">
                    <ReactMarkdown
                      ...
                      components={{
                        ...
                        li: ({ node, ...props }: any) => (
                          <li className="text-base sm:text-[17px] leading-[1.65] pl-2" {...props} />
                        ),
                        strong: ({ node, ...props }: any) => (
                          <strong className="font-semibold" {...props} />
                        ),
                        h3: ({ node, ...props }: any) => (
                          <h3 className="text-lg font-semibold text-text mb-3 mt-6" {...props} />
                        ),
                        a: ({ node, ...props }: any) => (
                          <a className="text-brand-ink hover:underline font-medium" {...props} />
                        ),
                ...
                {params.category === 'foundations' && howToUseCards.length >= 3 ? (
                      ...
                      <div className="text-text leading-relaxed text-base prose prose-sm max-w-none">
                        <ReactMarkdown
                          ...
                          components={{
                            ...
                            li: ({ node, ...p }: any) => <li {...p} />,
                            a: ({ node, ...p }: any) => (
                              <a className="text-brand-ink hover:underline font-medium" {...p} />
                            ),
                          }}
                        >
                          {howToUseCards[0]?.content || ''}
                        </ReactMarkdown>
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-6 border border-border-subtle shadow-sm hover:shadow-md transition-all">
                  ...
                  <div className="space-y-8">
                    <div className="bg-surface rounded-2xl p-8 md:p-10 shadow-sm relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        <h3 className="text-text font-serif-playfair text-2xl sm:text-[28px] font-semibold mb-4">
                          {howToUseWorkflow.title}
                        </h3>
                        <p className="text-text text-base sm:text-[17px] leading-[1.65] mb-8">
                          {howToUseWorkflow.description}
                        </p>
                        <div className="flex flex-nowrap items-stretch gap-3 md:gap-4 overflow-x-auto pb-2 -mx-1">
                          {howToUseWorkflow.steps.flatMap((step, i) => [
                            <div
                              key={`s-${i}`}
                              className="bg-white rounded-xl p-4 md:p-5 border border-border-subtle shadow-md flex-shrink-0 flex-1 min-w-[7rem] md:min-w-0 flex flex-col"
                            >
                              <div className="text-brand-ink text-sm font-bold mb-2 tracking-wider">
                                {step.number}
                              </div>
                              <h4 className="text-text font-bold text-base mb-1.5">{step.title}</h4>
                              <p className="text-text text-sm text-text-subtle leading-snug mt-auto">
                                {step.subtitle}
                              </p>
                            </div>,
                            ...(i < howToUseWorkflow.steps.length - 1
                              ? [
                                  <div
                                    key={`a-${i}`}
                                    className="flex items-center justify-center flex-shrink-0 self-stretch"
                                  >
                                    <ArrowRight className="text-[#cbd5e1] w-5 h-5 md:w-6 md:h-6" />
                                  </div>,
                                ]
                              : []),
                          ])}
                  ...
                  <div className="space-y-8">
                    <div className="bg-surface rounded-2xl p-8 shadow-sm relative overflow-hidden">
                      <div className="absolute top-0 right-0 w-64 h-64 bg-white rounded-full -mr-32 -mt-32 opacity-30"></div>
                      <div className="relative z-10">
                        <h3 className="text-text font-serif-playfair text-2xl sm:text-[28px] font-semibold mb-3">
                          {howToUseWorkflow.title}
                        </h3>
                        <p className="text-text text-base sm:text-[17px] opacity-80 mb-8 leading-[1.65]">
                          {howToUseWorkflow.description}
                        </p>
                        <div className="flex flex-nowrap items-center justify-between gap-2 md:gap-3 lg:gap-4">
                          {howToUseWorkflow.steps.flatMap((step, i) => [
                            <div
                              key={`s-${i}`}
                              className="bg-white rounded-lg p-3 md:p-4 border border-border-subtle shadow-sm min-h-[5.5rem] flex flex-col flex-shrink-0 flex-1 min-w-0"
                            >
                              <div className="text-brand-ink text-xs font-semibold mb-1.5 tracking-wide">
                                {step.number}
                              </div>
                              <h4 className="text-text font-bold text-sm mb-1">{step.title}</h4>
                              <p className="text-text text-xs opacity-70 leading-tight">
                                {step.subtitle}
                              </p>
                            </div>,
                            ...(i < howToUseWorkflow.steps.length - 1
                              ? [
                                  <ArrowRight
                                    key={`a-${i}`}
                                    className="text-[#e5e7eb] w-4 h-4 md:w-5 md:h-5 flex-shrink-0"
                                  />,
                                ]
                              : []),
                          ])}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {howToUseCards.map((card, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className="bg-white rounded-lg p-6 border border-border-subtle shadow-sm hover:shadow-md transition-all"
                        >
                          <div className="flex items-center gap-3 mb-4">
                            <div
                              className={`w-12 h-12 ${iconBg[i % iconBg.length]} rounded-lg flex items-center justify-center`}
                            >
                  ...
                  <div className="prose prose-lg max-w-none text-text">
                    <ReactMarkdown
                      ...
                      components={{
                        p: ({ node, ...props }: any) => (
                          <p className="text-base sm:text-[17px] leading-[1.65] mb-4" {...props} />
                        ),
                        ul: ({ node, ...props }: any) => (
                        ...
                        li: ({ node, ...props }: any) => (
                          <li className="text-base sm:text-[17px] leading-[1.65]" {...props} />
                        ),
                        strong: ({ node, ...props }: any) => (
                          <strong className="font-semibold" {...props} />
                        ),
                        ...
                        h3: ({ node, ...props }: any) => (
                          <h3 className="text-xl font-semibold text-text mb-3 mt-6" {...props} />
                        ),
                        h4: ({ node, ...props }: any) => (
                  ...
                  <div className="prose prose-lg max-w-none text-text">
                    <ReactMarkdown
                      ...
                      components={{
                        ...
                        ul: ({ node, ...props }: any) => (
                          <ul className="list-disc list-outside space-y-3 mb-4 ml-6" {...props} />
                        ),
                        li: ({ node, ...props }: any) => (
                          <li className="text-base sm:text-[17px] leading-[1.65] pl-2" {...props} />
                        ),
