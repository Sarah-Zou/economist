...
export default function InvestorDeckAccelerator() {
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-8 pt-12">
        ...
        <div className="md:col-span-3 flex flex-col items-center md:items-end pr-0 md:pr-8">
          <div className="relative w-[260px] h-[320px] md:w-[280px] md:h-[340px] rounded-tl-[90px] rounded-br-[90px] overflow-hidden shadow-lg border border-[#e5e7eb] bg-white mb-8 md:mb-0">
            <Image src="/images/S-1.webp" alt="Investor Deck Accelerator" fill className="object-cover" />
          </div>
        </div>
        {/* Main Content */}
        <main className="md:col-span-9 bg-white rounded-tl-[60px] rounded-br-[60px] shadow-lg border border-[#e5e7eb] px-8 md:px-16 py-12 flex flex-col justify-center">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <h1 className="font-serif-playfair text-5xl font-bold text-[#223] mb-2 leading-tight">Investor Deck Accelerator</h1>
            <span className="text-[#ff5722] text-lg font-medium">Close the credibility gap—walk into your next investor call with a board-worthy deck, built in 48 hours.</span>
          </div>
          <div className="my-8" />
          <div className="space-y-10">
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">Why Founders Choose This</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Investor meetings looming and no time to polish slides</li>
                <li>"Good enough" narrative isn't landing the valuation you deserve</li>
                <li>Conflicting metrics scattered across sheets</li>
              </ul>
            </section>
            <section>
            ...
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">How It Works (48 h sprint)</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Kickoff (1 h) – Share your current slides + metrics doc</li>
                <li>Build & Align (24 h) – I craft or refine slides, tighten the story</li>
                <li>Red-Flag Review (24 h) – Annotated deck + 30-min Loom walkthrough</li>
              </ul>
            </section>
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">Tangible Outcomes</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Investor-ready deck that passes the "5-minute skim" test</li>
                <li>Cohesive story that links vision → metrics → ask</li>
                <li>Confidence you won't be blindsided by data questions</li>
              </ul>
            </section>
            <section>
              <div className="text-base mb-2"><span className="font-bold">Investment:</span> $1.5k flat | 48 h turnaround</div>
            </section>
          </div>
          {/* CTA Box */}
