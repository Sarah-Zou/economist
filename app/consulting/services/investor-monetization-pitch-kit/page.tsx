...
export default function InvestorMonetizationPitchKit() {
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-8 pt-12">
        ...
        <div className="md:col-span-3 flex flex-col items-center md:items-end pr-0 md:pr-8">
          <div className="relative w-[260px] h-[320px] md:w-[280px] md:h-[340px] rounded-tl-[90px] rounded-br-[90px] overflow-hidden shadow-lg border border-[#e5e7eb] bg-white mb-8 md:mb-0">
            <Image src="/images/P-7.webp" alt="Investor Monetization Pitch Kit" fill className="object-cover" />
          </div>
        </div>
        {/* Main Content */}
        <main className="md:col-span-9 bg-white rounded-tl-[60px] rounded-br-[60px] shadow-lg border border-[#e5e7eb] px-8 md:px-16 py-12 flex flex-col justify-center">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <h1 className="font-serif-playfair text-5xl font-bold text-[#223] mb-2 leading-tight">Investor Monetization Pitch Kit</h1>
            <span className="text-[#ff5722] text-lg font-medium">Craft compelling monetization narratives for investor presentations.</span>
          </div>
          <div className="my-8" />
          <div className="space-y-10">
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Communicate monetization strategy effectively to investors</li>
                <li>Build confidence in revenue growth potential</li>
                <li>Align pricing strategy with investor expectations</li>
              </ul>
            </section>
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">What You Get</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Monetization narrative framework</li>
                <li>Pitch deck templates and examples</li>
                <li>Investor Q&A preparation guide</li>
              </ul>
            </section>
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">Process</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Strategy review and messaging development</li>
            ...
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Compelling monetization story</li>
                <li>Confident investor presentations</li>
                <li>Strong investor relationships</li>
              </ul>
            </section>
            <section>
