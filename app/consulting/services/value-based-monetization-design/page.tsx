...
export default function ValueBasedMonetizationDesign() {
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-8 pt-12">
        ...
        <div className="md:col-span-3 flex flex-col items-center md:items-end pr-0 md:pr-8">
          <div className="relative w-[260px] h-[320px] md:w-[280px] md:h-[340px] rounded-tl-[90px] rounded-br-[90px] overflow-hidden shadow-lg border border-[#e5e7eb] bg-white mb-8 md:mb-0">
            <Image src="/images/P-3.webp" alt="Value-Based Monetization Design" fill className="object-cover" />
          </div>
        ...
        <main className="md:col-span-9 bg-white rounded-tl-[60px] rounded-br-[60px] shadow-lg border border-[#e5e7eb] px-8 md:px-16 py-12 flex flex-col justify-center">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <h1 className="font-serif-playfair text-5xl font-bold text-[#223] mb-2 leading-tight">Value-Based Monetization Design</h1>
            <span className="text-[#ff5722] text-lg font-medium">Design a monetization strategy that aligns with your product's value.</span>
          </div>
          <div className="my-8" />
          <div className="space-y-10">
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Align pricing with customer value perception</li>
                <li>Maximize revenue while maintaining customer satisfaction</li>
                <li>Create sustainable monetization strategies</li>
              </ul>
            </section>
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                ...
                <li>Monetization model recommendations</li>
            ...
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Value analysis and market research</li>
                <li>Pricing model design and testing</li>
            ...
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Optimized pricing strategy</li>
                <li>Increased revenue and customer satisfaction</li>
                <li>Clear path to implementation</li>
              </ul>
            </section>
            <section>
