    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="font-serif-playfair text-4xl md:text-5xl lg:text-6xl font-bold text-[#223] mb-6 leading-tight max-w-4xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto space-y-24">
          ...
          <section className="text-center">
            <h2 className="font-serif-playfair text-3xl md:text-4xl font-bold text-[#223] mb-4">What It Is</h2>
          ...
          <section className="text-center">
            <h2 className="font-serif-playfair text-3xl md:text-4xl font-bold text-[#223] mb-8">Why It Matters Now</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {[
                ...
                <div key={idx} className="bg-white rounded-lg p-6 border border-[#e5e7eb] shadow-sm text-left">
                  ...
                  <h3 className="font-bold text-lg text-[#223] mb-3">{item.title}</h3>
                  <p className="text-base text-[#4b636e] font-light">{item.desc}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          {/* Outcomes Section */}
          <section className="text-center">
            <h2 className="font-serif-playfair text-3xl md:text-4xl font-bold text-[#223] mb-4">Outcomes (what you get every month)</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {[
                ...
                <div key={idx} className="bg-white rounded-lg p-6 border border-[#e5e7eb] shadow-sm text-left">
                  ...
                  <h3 className="font-bold text-lg text-[#223] mb-3">{outcome.title}</h3>
                  <p className="text-base text-[#4b636e] font-light">{outcome.desc}</p>
                </div>
              ))}
          </div>
          </section>
          ...
          {/* What I Own Section */}
            <section>
            <h2 className="font-serif-playfair text-3xl md:text-4xl font-bold text-[#223] mb-8 text-center">What I Own (by function)</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              {[
                ...
                <div key={idx} className="bg-white rounded-lg p-6 border border-[#e5e7eb] shadow-sm">
                  <h3 className="font-bold text-lg text-[#223] mb-4">{area.function}</h3>
                  <ul className="space-y-2">
                    {area.items.map((item, itemIdx) => (
                      <li key={itemIdx} className="text-base text-[#4b636e] font-light flex items-start gap-3">
          ...
          <section className="text-center">
            <h2 className="font-serif-playfair text-3xl md:text-4xl font-bold text-[#223] mb-12">Plans & Pricing</h2>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                {[
                  ...
                  >
                    <div className="mb-6">
                      <h4 className="font-serif-playfair text-2xl font-bold text-[#06b6d4] mb-2 text-left">{tier.name}</h4>
                      <p className="text-sm text-[#4b636e] font-light text-left leading-relaxed mb-3">{tier.description}</p>
                      <div className="mb-2 text-left">
                        ...
                        <span className="text-sm text-[#4b636e] font-light ml-2">({tier.timeCommitment})</span>
                      </div>
                    </div>
                    <ul className="space-y-3 flex-grow mb-6 text-left">
                      {tier.features.map((feature, featIdx) => (
                        <li key={featIdx} className="flex items-start gap-3">
                          ...
                          <span className="text-sm text-[#4b636e] font-light">{feature}</span>
                        </li>
                      ))}
              </ul>
                    <a
          ...
          {/* Core Deliverables Section */}
            <section>
            <h2 className="font-serif-playfair text-3xl md:text-4xl font-bold text-[#223] mb-8 text-center">Core Deliverables (menu)</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {[
                ...
                <div key={idx} className="bg-white rounded-lg p-6 border border-[#e5e7eb] shadow-sm">
                  ...
                  <h3 className="font-bold text-lg text-[#223] mb-3">{deliverable.title}</h3>
                  <p className="text-base text-[#4b636e] font-light">{deliverable.desc}</p>
                </div>
              ))}
            </div>
          ...
          {/* Operating Cadence & How This Fits Section */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              <div>
                <h2 className="font-serif-playfair text-3xl md:text-4xl font-bold text-[#223] mb-6">Operating Cadence</h2>
        ...
        <div className="max-w-4xl mx-auto mt-16">
          <div className="bg-white rounded-lg p-8 md:p-12 border border-[#e5e7eb] shadow-lg text-center">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <h2 className="font-serif-playfair text-2xl md:text-3xl font-bold text-[#223]">Ready to own your monetization?</h2>
          </div>
