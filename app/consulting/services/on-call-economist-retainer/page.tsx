...
export default function OnCallEconomistRetainer() {
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-8 pt-12">
        ...
        <div className="md:col-span-3 flex flex-col items-center md:items-end pr-0 md:pr-8">
          <div className="relative w-[260px] h-[320px] md:w-[280px] md:h-[340px] rounded-tl-[90px] rounded-br-[90px] overflow-hidden shadow-lg border border-[#e5e7eb] bg-white mb-8 md:mb-0">
            <Image src="/images/S-6.webp" alt="On-Call Economist Retainer" fill className="object-cover" />
          </div>
        </div>
        {/* Main Content */}
        <main className="md:col-span-9 bg-white rounded-tl-[60px] rounded-br-[60px] shadow-lg border border-[#e5e7eb] px-8 md:px-16 py-12 flex flex-col justify-center">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <h1 className="font-serif-playfair text-5xl font-bold text-[#223] mb-2 leading-tight">On-Call Economist Retainer</h1>
            <span className="text-[#ff5722] text-lg font-medium">Get a fractional SaaS economist in your corner for pricing, metrics, and board prep.</span>
          </div>
          <div className="my-8" />
          <div className="space-y-10">
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Founders and CFOs need expert, unbiased advice on pricing, metrics, and market moves</li>
                <li>Internal teams are stretched thin or lack SaaS-specific expertise</li>
                <li>Board meetings and investor updates require sharp, data-driven insights</li>
              </ul>
            </section>
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                ...
                <li>Unlimited async Q&A via email/Slack</li>
                <li>Rapid-turnaround on ad hoc analysis (1-2 days)</li>
              </ul>
            </section>
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">How It Works</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Kickoff call to align on goals & priorities</li>
                <li>Ongoing support for pricing, metrics, and board prep</li>
                <li>Quarterly check-ins to review progress</li>
              </ul>
            </section>
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                ...
                <li>Stronger board and investor relationships</li>
                <li>Access to SaaS-specific best practices</li>
              </ul>
            </section>
            <section>
              <div className="text-base mb-2"><span className="font-bold">Timeline & Price:</span> Ongoing | $2k/mo</div>
            </section>
          </div>
          {/* CTA Box */}
