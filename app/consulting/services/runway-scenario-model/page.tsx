...
export default function RunwayScenarioModel() {
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-8 pt-12">
        ...
        <div className="md:col-span-3 flex flex-col items-center md:items-end pr-0 md:pr-8">
          <div className="relative w-[260px] h-[320px] md:w-[280px] md:h-[340px] rounded-tl-[90px] rounded-br-[90px] overflow-hidden shadow-lg border border-[#e5e7eb] bg-white mb-8 md:mb-0">
            <Image src="/images/S-4.webp" alt="Runway & Scenario Model" fill className="object-cover" />
          </div>
        ...
        <main className="md:col-span-9 bg-white rounded-tl-[60px] rounded-br-[60px] shadow-lg border border-[#e5e7eb] px-8 md:px-16 py-12 flex flex-col justify-center">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <h1 className="font-serif-playfair text-5xl font-bold text-[#223] mb-2 leading-tight">Runway & Scenario Model</h1>
            <span className="text-[#ff5722] text-lg font-medium">Know exactly how much you can spend, hire, or discount—without running out of cash.</span>
          </div>
          <div className="my-8" />
          <div className="space-y-10">
            <section>
              ...
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Founders and CFOs need to make hiring, pricing, and spend decisions with confidence</li>
                <li>Most models are too complex, fragile, or out of date</li>
                <li>Investors want to see scenario thinking, not just a single forecast</li>
              </ul>
            </section>
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">Deliverables</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Custom Google Sheet model (12-24 month runway, 3 scenarios)</li>
                <li>Inputs for headcount, pricing, churn, and growth</li>
                <li>30-min Loom walkthrough</li>
              </ul>
            </section>
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">Process</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Intake on current cash, burn, and goals</li>
                <li>Model build & review</li>
                <li>Scenario walkthrough & handoff</li>
              </ul>
            </section>
            <section>
              <h2 className="font-serif-playfair text-2xl font-bold text-[#223] mb-2">Outcomes</h2>
              <ul className="list-disc ml-6 text-base text-[#4b636e] font-light space-y-1">
                <li>Clarity on how long your cash will last in each scenario</li>
                <li>Confidence to make key decisions</li>
                <li>Investor-ready scenario planning</li>
              </ul>
            </section>
            <section>
