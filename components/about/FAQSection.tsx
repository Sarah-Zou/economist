      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="bg-white rounded-lg p-5 sm:p-6 border border-[#e5e7eb] shadow-sm">
            ...
            <p className="text-base sm:text-[17px] text-[#1f2933] leading-[1.65]">
              Start with a 15-min consult → pick a <Link href="/consulting/services/pricing-monetization-sprint" className={brandLink}>Monetization Sprint</Link> or <Link href="/consulting/services/metrics-experimentation-sprint" className={brandLink}>Metrics Sprint</Link> → optional <Link href="/consulting/services/on-call-economist-retainer" className={brandLink}>retainer</Link> for ongoing pricing moves, forward models, and experiment cadence. Fixed deliverables, clear timelines.
            </p>
          </div>
          <div className="bg-white rounded-lg p-5 sm:p-6 border border-[#e5e7eb] shadow-sm">
