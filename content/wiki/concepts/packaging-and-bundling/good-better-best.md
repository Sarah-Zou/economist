...
| **The "Price Cliff":** The jump from Good to Better is too expensive (e.g., $9 to $99). | Create a "Bridge" offer or add a [seat-based](/wiki/pricing/models-and-metering/seat-based-pricing) variable to smooth the transition. |
