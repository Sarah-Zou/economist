...
| **Spend is hard to predict (bursty / volatile / low natural frequency):** customers can't (or won't) commit to a steady monthly fee; usage may be sporadic. | Prefer [**hybrids**](/wiki/pricing/models-and-metering/hybrid-pricing): [prepaid credits](/wiki/pricing/models-and-metering/credits-drawdown-model) or minimum + overage (two-part tariff). If predictability is paramount → [**subscription**](/wiki/pricing/models-and-metering/subscription-model) with included transactions + overages. |
...
**A:** Sometimes, but many want predictability—[hybrids](/wiki/pricing/models-and-metering/hybrid-pricing) (minimums/committed spend) are often easier to procure. Or offer a [credits / drawdown model](/wiki/pricing/models-and-metering/credits-drawdown-model) where they buy a block of transactions upfront (e.g., Audible credits). This provides predictability for them and cash flow for you.
