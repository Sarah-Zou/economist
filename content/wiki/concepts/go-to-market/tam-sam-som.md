...
**A:** A large TAM shows the ceiling; a focused SAM and a capacity-based SOM show you know where you'll win first and that the operating plan is realistic. Both jobs matter—see [how startup funding works](/fundraising/how-startup-funding-works) for round sizing, and [Pre-Seed, Seed, and Series A](/fundraising/pre-seed-seed-series-a) for how investor expectations shift by stage.
