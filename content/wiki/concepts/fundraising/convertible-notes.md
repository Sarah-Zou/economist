...
**Why founders use it:** A note can close faster than a priced round because the company does not have to negotiate a full preferred-stock financing immediately. But the speed comes from deferring the share price, not from eliminating financing cost. Convertible notes are one instrument in the broader map of [how startup funding works](/fundraising/how-startup-funding-works), and they still appear in some [pre-seed and seed](/fundraising/pre-seed-seed-series-a) financings even as SAFEs dominate.
