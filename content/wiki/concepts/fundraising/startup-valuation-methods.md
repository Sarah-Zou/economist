...
**What it is:** Startup valuation is the process of estimating or negotiating what a company or a class of its securities is worth, for a defined purpose and as of a defined date. In a priced financing, the valuation sets the price per share and therefore how much ownership the investment buys. It sits inside the financing decision described in [how startup funding works](/fundraising/how-startup-funding-works), and investor expectations shift by [pre-seed, seed, and Series A](/fundraising/pre-seed-seed-series-a).
